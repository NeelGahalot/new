...
from yolo_utils.coco_utils import getCocoIds, getMappingId, getMappingIndex
...
from yolo_utils.panoptic.dataloaders import create_dataloader
from yolo_utils.panoptic.general import mask_iou, process_mask, process_mask_upsample, scale_image
from yolo_utils.panoptic.metrics import Metrics, ap_per_class_box_and_mask, Semantic_Metrics
from yolo_utils.panoptic.plots import plot_images_and_masks
...
def run(
    ...
    if save_json and len(jdict):
        ...
        try:  # https://github.com/cocodataset/cocoapi/blob/master/PythonAPI/pycocoEvalDemo.ipynb
            ...
            # Semantic Segmentation
            from yolo_utils.stuff_seg.cocostuffeval import COCOStuffeval
