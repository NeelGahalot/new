...
from yolo_utils.general import (LOGGER, TQDM_BAR_FORMAT, check_amp, check_dataset, check_file, check_img_size,
...
from yolo_utils.loss_tal import ComputeLoss
from yolo_utils.metrics import fitness
from yolo_utils.plots import plot_evolve
from yolo_utils.torch_utils import (EarlyStopping, ModelEMA, de_parallel, select_device, smart_DDP,
...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    # from yolo_utils.plots import plot_lr_scheduler; plot_lr_scheduler(optimizer, scheduler, epochs)
