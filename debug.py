...
def get_argparser():
    ...
    parser.add_argument("--csv", default='/teamspace/studios/this_studio/Deeplab/pilot_eastafrica_haiti_freetown_WITH_deeplab_crf_sam.csv', type=str,
    ...
    parser.add_argument("--sample_dir", default='pilot_with_crf/samples', type=str,
                        help="S3 sample dir to upload samples.")
    parser.add_argument("--mask_dir", default='pilot_with_crf/binary_masks', type=str,
    ...
    parser.add_argument("--output_file_path", default='/teamspace/studios/this_studio/pilot_with_crf.csv', type=str,
    ...
    parser.add_argument("--max_itr", default= 10,
