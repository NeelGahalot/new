...
from datasets import LeafDataset_old
        ...
        for (images, labels) in train_loader:
            ...
            if (cur_itrs) % opts.val_interval == 0:
                ...
                if val_score['IoU Foreground'] > best_score and opts.save_checkpoint:  # save best model
                    ...
                    save_ckpt('saved_models/crf_sam_large_freetown_eastafrica_haiti_sam_threshold_95_without_prob%s.pth' % ((val_score['IoU Foreground'])))
                    print('saved here.')
